...
# 🔹 Update author name & GitHub link
st.markdown("""
Made with ❤️ by [Debashis Dhar](https://github.com/FantomDeba/RAG_PROJECT)\n
Star ⭐ this repo on [GitHub](https://github.com/FantomDeba/RAG_PROJECT)
""", unsafe_allow_html=True)
...
So, expecting it to answer any question other than used for training with high accuracy is not a good idea.
You can [have a look at all the 80 questions](https://github.com/FantomDeba/RAG_PROJECT/blob/main/Ecommerce_FAQs.csv)
